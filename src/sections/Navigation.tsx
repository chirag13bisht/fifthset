...
export default function Navigation() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const lightSectionIds = ['anatomy', 'tiers', 'contact', 'footer'];
  ...
  return (
    ...
    >
      <div
        className="liquid-glass nav-bar-inner"
        style={{
          maxWidth: '1200px',
          margin: '0 auto',
          padding: '14px 32px',
      ...
      >
        {navigationConfig.brandName ? (
          ...
          >
            <img
              src={isLightSection ? 'images/logo-mark-dark.png' : 'images/logo-mark-ivory.png'}
              alt="Fifth Set Collective monogram"
              style={{ height: '30px', width: 'auto', display: 'block', transition: 'opacity 0.6s ease' }}
            />
            {navigationConfig.brandName}
          </a>
        ) : (
        ...
        <div className="nav-links-row" style={{ display: 'flex', gap: '28px', alignItems: 'center' }}>
